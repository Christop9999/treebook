...
class UserFriendshipsControllerTest < ActionController::TestCase
 ...
 context "#index" do 
  ...
  should "display friens's names" do
  ...
  context "#new" do 
    ...
    should "should set a flash error if the friend id params is missing" do
  	...
  	should "assign a new friendship" do
  		get :new, friend_id: users(:jim)
  		assert assigns(:user_friendship) ##assert a user friendship object gets assigned
  	end
  	...
  	should "the user is the currentlly logged in user" do
  		get :new, friend_id: users(:jim)
    ...
    should "ask if you really want this friendship" do
    	get :new, friend_id: users(:jim)
  ...
  context "#create" do
    ...
    should "be redirected to root path" do
  ...
  context "sucessfully" do
    should "create two users frienship objects" do
  ...
  context "with a valid friend_id" do
    ...
    should "redirect to the profile page of a friend" do
      assert_response :redirect
